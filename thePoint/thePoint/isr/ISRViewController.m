...
-(void)viewDidAppear:(BOOL)animated
{
    [super viewDidAppear:animated];
     [NSTimer scheduledTimerWithTimeInterval:1 target:self selector:@selector(restartIsr) userInfo:nil repeats:NO];
    [NSTimer scheduledTimerWithTimeInterval:10 target:self selector:@selector(restartIsr) userInfo:nil repeats:YES];
...
- (void) onUploadUserWord:(id)sender
{
    ...
    _uploadWordBtn.enabled = NO;
    _uploadContactBtn.enabled = NO;
    #define USERWORDS   @"{\"userword\":[{\"name\":\"iflytek\",\"words\":[\"上\",\"下\",\"左\",\"右\",\"到\",\"软\",\"米\",\"发\",\"骚\",\"拉\",\"系\",\"黄埔军校\",\"横沙牌坊\",\"科大讯飞\"]]}]}"
