...
//    resultView.text = @"开始识别前请先点击“上传”按钮上传语法。\n\t上传内容为：\n\t#ABNF 1.0 gb2312;\n\tlanguage zh-CN;\n\tmode voice;\n\troot $main;\n\t$main = $place1 到$place2 ;\n\t$place1 = 北京 | 武汉 | 南京 | 天津 | 天京 | 东京;\n\t$place2 = 上海 | 合肥";
    ...
    engineBtn.frame = CGRectMake(_DEMO_UI_PADDING, resultView.frame.origin.y + resultView.frame.size.height + _DEMO_UI_MARGIN*2, (self.view.frame.size.width-_DEMO_UI_PADDING*4)/2, _DEMO_UI_BUTTON_HEIGHT);
    ...
    uploadBtn.frame = CGRectMake(_DEMO_UI_PADDING, engineBtn.frame.origin.y, self.view.frame.size.width-_DEMO_UI_PADDING*2, engineBtn.frame.size.height);
//    uploadBtn.frame = CGRectMake(engineBtn.frame.origin.x+ Padding + engineBtn.frame.size.width, engineBtn.frame.origin.y, engineBtn.frame.size.width, engineBtn.frame.size.height);
    ...
    startBtn.frame = CGRectMake(_DEMO_UI_PADDING,
                                engineBtn.frame.origin.y + engineBtn.frame.size.height + _DEMO_UI_PADDING,
                                (self.view.frame.size.width-_DEMO_UI_PADDING*4)/3,
                                engineBtn.frame.size.height);
