...
- (void)loadView
{
    ...
    int height;
    height = self.view.frame.size.height - _DEMO_UI_BUTTON_HEIGHT*2 - _DEMO_UI_MARGIN*8-_DEMO_UI_NAVIGATIONBAR_HEIGHT;
    UITextView *resultView = [[UITextView alloc] initWithFrame:
                              CGRectMake(_DEMO_UI_MARGIN*2, _DEMO_UI_MARGIN*2, self.view.frame.size.width-_DEMO_UI_MARGIN*4, height)];
    ...
    uploadBtn.frame = CGRectMake(_DEMO_UI_PADDING, resultView.frame.origin.y + resultView.frame.size.height + _DEMO_UI_MARGIN*2, (self.view.frame.size.width-_DEMO_UI_PADDING*3)/2, _DEMO_UI_BUTTON_HEIGHT);
    ...
    startBtn.frame = CGRectMake(uploadBtn.frame.origin.x+ _DEMO_UI_PADDING + uploadBtn.frame.size.width, uploadBtn.frame.origin.y, uploadBtn.frame.size.width, uploadBtn.frame.size.height);
    ...
    stopBtn.frame = CGRectMake(_DEMO_UI_PADDING, startBtn.frame.origin.y + startBtn.frame.size.height + _DEMO_UI_MARGIN, (self.view.frame.size.width-_DEMO_UI_PADDING*3)/2, _DEMO_UI_BUTTON_HEIGHT);
